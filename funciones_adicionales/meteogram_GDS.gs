...
if (arg='')
  say 'The unit arg was not provided, using default metric units'
  units='m'
else
  units=subwrd(arg,1)
  if (units!='m' & units!='e')
...
'open mysubset.ctl'
if (rc)
  say 'Failed to open mysubset.ctl'
  return
endif
'open mysubsetp.ctl'
if (rc)
  say 'Failed to open mysubsetp.ctl'
  return
endif
...
label = '`1GFS 0~10day 3-hourly Forecast Meteogram for ('
...
if (print)
  'gxprint mymeteogram.png x1100 y1100'
endif
